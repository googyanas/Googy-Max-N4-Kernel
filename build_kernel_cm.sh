...
export RAMFS_SOURCE="/home/googy/Kernel/Googy-Max-N4/Ramdisk_cm"
export PARENT_DIR=`readlink -f ..`
export USE_SEC_FIPS_MODE=true
export CROSS_COMPILE=/usr/bin/arm-linux-gnu-

RAMFS_TMP="/home/googy/Kernel/Googy-Max-N4/Ramdisk_cm_tmp/tmp"
...
tools/mkbootimg --kernel $KERNELDIR/arch/arm/boot/zImage --dt tools/dt.img --ramdisk /home/googy/Kernel/Googy-Max-N4/Ramdisk_cm_tmp/tmp.cpio.gz --base 0x10000000 --kernel_offset 0x10000000 --ramdisk_offset 0x10008000 --tags_offset 0x10000100 --pagesize 2048 -o $KERNELDIR/boot.img

cd /home/googy/Kernel/Googy-Max-N4
mv -f -v /home/googy/Kernel/Googy-Max-N4/Kernel/boot.img /home/googy/Kernel/Googy-Max-N4/Release_cm/boot.img
cd /home/googy/Kernel/Googy-Max-N4/Release_cm
zip -r ../Googy-Max-N4_CM_Kernel_${1}_CWM.zip .

adb push /home/googy/Kernel/Googy-Max-N4/Googy-Max-N4_CM_Kernel_${1}_CWM.zip /storage/sdcard0/Googy-Max-N4_CM_Kernel_${1}_CWM.zip
